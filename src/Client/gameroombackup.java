...
public class gameroombackup extends javax.swing.JPanel {
    ...
    private void initGUI(){
        JLabel[] labels = {role0, role1, role2, role3, role4, role5, role6, role7, role8, role9};
        for(int i = 0 ; i < 10; i++ ){
            states[i] = new State();
            states[i].idRole = i;
            states[i].setLabel(labels[i]);
            String path = Constaint.pathRoot + "/assets/icon_role" + i + ".png";
            states[i].label.setIcon(gui.resizeImage(path, 24, 24));
        }
        for(int i = 0; i < 9;i++){
...
//        reloadPlayers();
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnExit);
        btnExit.setBounds(710, 60, 140, 32);
        ...
        jScrollPane2.setBounds(400, 100, 455, 320);
